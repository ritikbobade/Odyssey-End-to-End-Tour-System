            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="optdestinationtype"   value="historical"  >Cities filled with history and culture
                        </label>  
                        <label class="radio">
            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="optcompany" value="Family"   >Family
                        </label>
                        <label class="radio">
            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="opttime"  value=""  >Summer
                        </label>
                        <label class="radio">
            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="optagegroup" value="Young"   >Young
                        </label>
                        <label class="radio">
            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="optbudget" value="10,000"    >10,000
                        </label>
                        <label class="radio">
            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="opttransportationmode" value="Train"    >Train
                        </label>
                        <label class="radio">
            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="optstay" value="Hotel"    >Hotel
                        </label>
                        <label class="radio">
            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="optrelax" value="Take a bath and read a good book"    >Take a bath and read a good book
                        </label>
                        <label class="radio">
            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="optpreparing"  value="Reading about the history and culture of your destination"   >Reading about the history and culture of your destination
                        </label>
                        <label class="radio">
            ...
            <div class="panel-body">
                <div class="question-box"> 
                    <div class="custom-input-group">
                        ...
                        <label class="radio">
                          <input type="radio" name="optessential" value="Hiking boots"    >Hiking boots
                        </label>
                        <label class="radio">
                ...
                <button class="btn btn-success book-btn pull-right" name="QuestionFormSubmit" id="QuestionFormSubmit" type="button">Finish!</button>
            </div>
        </div>
